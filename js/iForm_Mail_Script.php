...
$errorPage = “failure.html”; // Relative path for page to redirect to on error, error numbers will be in a GET variable

// E-Mail
$recipient = “dale.dupree85@gmail.com”; // Address to deliver form to
$subject = "dale.dupree85@gmail.com"; // Subject of the E-Mail
$from = "dale.dupree85@gmail.com"; // From address if server requires it or if E-Mail address is optional
$name = "dale.dupree85@gmail.com"; // The name of the sender, if required
...
$errorStrings = array(
	...
	3 => 'email could not be delivered',
	4 => 'sendForm78071', // No real error message for this
);
...
if (($input_type == INPUT_POST && !empty($_POST['sendForm78071']) ||
	($input_type == INPUT_GET && !empty($_GET['sendForm78071']))))
{
	// Probably not
	appendError(4);
}
